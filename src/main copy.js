...
//const roleBobAttack = require('./role.bobAttack');
...
module.exports.loop = function () {
    ...
    // var fooWho = Game.spawns.Spawn2.memory.EnergyManagement.foo.who;
    // console.log('<font color = "yellow">[' + fileName + 'line:' + util.LineNumber() + '] foo.who is ' + foo.who + '</>');
