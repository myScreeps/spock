...
module.exports = {
    ...
    run: function (creep) {
        ...
        var isNearToTerminal = creep.pos.isNearTo(creep.room.terminal);
        var isNearToStorage = creep.pos.isNearTo(creep.room.storage);
